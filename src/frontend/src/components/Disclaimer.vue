<template>
  <div>
    ...
    <p>A sample merchant mobile app that can be used together with this backend is available on <a href="https://play.google.com/store/apps/details?id=com.signicat.sampleapp.inapp">Google Play</a> and the source code is available on <a href="https://github.com/signicat/sample-mobileid-app-common-react-native">GitHub</a></p>
    ...
    <p>This sample code is provided without a warranty of any kind, either express or implied, including but not limited to, the implied warranties of merchantability, fitness for a particular purpose, or non-infringement.</p>
    <p>Signicat assumes no responsibility for errors in this sample code.</p>
  </div>
</template>
